...
CHANNEL_TEMPLATES = {
    "Stereo (2.0)": {
        "channels": ["L", "R"],
        "patterns": [
            r"(^|[^a-zA-Z0-9.])(L|Left|FL|Front[_-]?Left)([^a-zA-Z0-9]|$)",
            r"(^|[^a-zA-Z0-9.])(R|Right|FR|Front[_-]?Right)([^a-zA-Z0-9]|$)"
        ]
    },
    "5.1 (6ch)": {
        ...
        "patterns": [
            r"(^|[^a-zA-Z0-9.])(L|Left|FL|Front[_-]?Left)([^a-zA-Z0-9]|$)",
            r"(^|[^a-zA-Z0-9.])(R|Right|FR|Front[_-]?Right)([^a-zA-Z0-9]|$)",
            r"(^|[^a-zA-Z0-9.])(C|Center|Centre|FC|Front[_-]?Center)([^a-zA-Z0-9]|$)",
            r"(^|[^a-zA-Z0-9.])(LFE|Lfe|Sub|Subwoofer|SW)([^a-zA-Z0-9]|$)",
            r"(^|[^a-zA-Z0-9.])(Ls|LS|Lss|Lsr|Left[_-]?Surround|Left[_-]?Rear|Surround[_-]?Left|SL|BL|Back[_-]?Left|Lrs)([^a-zA-Z0-9]|$)",
            r"(^|[^a-zA-Z0-9.])(Rs|RS|Rss|Rsr|Right[_-]?Surround|Right[_-]?Rear|Surround[_-]?Right|SR|BR|Back[_-]?Right|Rrs)([^a-zA-Z0-9]|$)"
        ]
    },
    "7.1 (8ch)": {
        ...
        "patterns": [
            ...
            r"(^|[^a-zA-Z0-9.])(C|Center|Centre|FC|Front[_-]?Center)([^a-zA-Z0-9]|$)",
            r"(^|[^a-zA-Z0-9.])(LFE|Lfe|Sub|Subwoofer|SW)([^a-zA-Z0-9]|$)",
            r"(^|[^a-zA-Z0-9.])(Lss|LSs|Left[_-]?Side|Side[_-]?Left|SL|Left[_-]?Side[_-]?Surround)([^a-zA-Z0-9]|$)",
            r"(^|[^a-zA-Z0-9.])(Rss|RSs|Right[_-]?Side|Side[_-]?Right|SR|Right[_-]?Side[_-]?Surround)([^a-zA-Z0-9]|$)",
            r"(^|[^a-zA-Z0-9.])(Lrs|LRs|Left[_-]?Rear|Rear[_-]?Left|LR|Back[_-]?Left|BL|Left[_-]?Back|Lsr)([^a-zA-Z0-9]|$)",
            r"(^|[^a-zA-Z0-9.])(Rrs|RRs|Right[_-]?Rear|Rear[_-]?Right|RR|Back[_-]?Right|BR|Right[_-]?Back|Rsr)([^a-zA-Z0-9]|$)"
        ]
    },
    "7.1.2 (10ch)": {
        ...
        "patterns": [
            ...
            r"(^|[^a-zA-Z0-9.])(Lrs|LRs|Left[_-]?Rear|Rear[_-]?Left|LR|Back[_-]?Left|BL|Left[_-]?Back|Lsr)([^a-zA-Z0-9]|$)",
            r"(^|[^a-zA-Z0-9.])(Rrs|RRs|Right[_-]?Rear|Rear[_-]?Right|RR|Back[_-]?Right|BR|Right[_-]?Back|Rsr)([^a-zA-Z0-9]|$)",
            r"(^|[^a-zA-Z0-9.])(Ltf|LtF|Left[_-]?Top[_-]?Front|Top[_-]?Front[_-]?Left|TFL|Lft|Left[_-]?Front[_-]?Top)([^a-zA-Z0-9]|$)",
            r"(^|[^a-zA-Z0-9.])(Rtf|RtF|Right[_-]?Top[_-]?Front|Top[_-]?Front[_-]?Right|TFR|Rft|Right[_-]?Front[_-]?Top)([^a-zA-Z0-9]|$)"
        ]
    },
    "5.1.4 (10ch)": {
        ...
        "patterns": [
            ...
            r"(^|[^a-zA-Z0-9.])(Ltf|LtF|Left[_-]?Top[_-]?Front|Top[_-]?Front[_-]?Left|TFL|Lft|Left[_-]?Front[_-]?Top)([^a-zA-Z0-9]|$)",
            r"(^|[^a-zA-Z0-9.])(Rtf|RtF|Right[_-]?Top[_-]?Front|Top[_-]?Front[_-]?Right|TFR|Rft|Right[_-]?Front[_-]?Top)([^a-zA-Z0-9]|$)",
            r"(^|[^a-zA-Z0-9.])(Ltr|LtR|Left[_-]?Top[_-]?Rear|Top[_-]?Rear[_-]?Left|TRL|Lrt|Left[_-]?Rear[_-]?Top|Ltb|Left[_-]?Top[_-]?Back)([^a-zA-Z0-9]|$)",
            r"(^|[^a-zA-Z0-9.])(Rtr|RtR|Right[_-]?Top[_-]?Rear|Top[_-]?Rear[_-]?Right|TRR|Rrt|Right[_-]?Rear[_-]?Top|Rtb|Right[_-]?Top[_-]?Back)([^a-zA-Z0-9]|$)"
        ]
    },
    "7.1.4 (12ch)": {
        ...
        "patterns": [
            ...
            r"(^|[^a-zA-Z0-9.])(Lrs|LRs|Left[_-]?Rear|Rear[_-]?Left|LR|Back[_-]?Left|BL|Left[_-]?Back|Lsr)([^a-zA-Z0-9]|$)",
            r"(^|[^a-zA-Z0-9.])(Rrs|RRs|Right[_-]?Rear|Rear[_-]?Right|RR|Back[_-]?Right|BR|Right[_-]?Back|Rsr)([^a-zA-Z0-9]|$)",
            r"(^|[^a-zA-Z0-9.])(Ltf|LtF|Left[_-]?Top[_-]?Front|Top[_-]?Front[_-]?Left|TFL|Lft)([^a-zA-Z0-9]|$)",
            r"(^|[^a-zA-Z0-9.])(Rtf|RtF|Right[_-]?Top[_-]?Front|Top[_-]?Front[_-]?Right|TFR|Rft)([^a-zA-Z0-9]|$)",
            r"(^|[^a-zA-Z0-9.])(Ltb|LtB|Left[_-]?Top[_-]?Back|Top[_-]?Back[_-]?Left|TBL|Lbt)([^a-zA-Z0-9]|$)",
            r"(^|[^a-zA-Z0-9.])(Rtb|RtB|Right[_-]?Top[_-]?Back|Top[_-]?Back[_-]?Right|TBR|Rbt)([^a-zA-Z0-9]|$)"
        ]
    },
}
...
class SmartMultiMonoDialog(QDialog):
    ...
    def _read_wav_channel_label(self, filepath: str) -> str:
    ...
    def _extract_channel_id(self, filename: str) -> str:
        """从文件名提取声道标识，支持常见变体"""
        # 1. 点号后缀（最高优先级）
        ...
        # 2. 从完整文件名搜索（支持无点号分隔的命名，如 Track_Ls_01）
        n = filename.upper()
        patterns = [
            (r'(^|[^A-Z0-9.])(LFE|SUB|SUBWOOFER|SW)([^A-Z0-9.]|$)', 'LFE'),
            (r'(^|[^A-Z0-9.])(LTR|TRL)([^A-Z0-9.]|$)', 'Ltr'),
            (r'(^|[^A-Z0-9.])(RTR|TRR)([^A-Z0-9.]|$)', 'Rtr'),
            (r'(^|[^A-Z0-9.])(LTB|TBL|LEFT.*TOP.*BACK|BACK.*TOP.*LEFT|TOP.*BACK.*LEFT)([^A-Z0-9.]|$)', 'Ltb'),
            (r'(^|[^A-Z0-9.])(RTB|TBR|RIGHT.*TOP.*BACK|BACK.*TOP.*RIGHT|TOP.*BACK.*RIGHT)([^A-Z0-9.]|$)', 'Rtb'),
            (r'(^|[^A-Z0-9.])(LTF|TFL|LEFT.*TOP.*FRONT|FRONT.*TOP.*LEFT|TOP.*FRONT.*LEFT)([^A-Z0-9.]|$)', 'Ltf'),
            (r'(^|[^A-Z0-9.])(RTF|TFR|RIGHT.*TOP.*FRONT|FRONT.*TOP.*RIGHT|TOP.*FRONT.*RIGHT)([^A-Z0-9.]|$)', 'Rtf'),
            (r'(^|[^A-Z0-9.])(LSS|SSL|LEFT.*SIDE|SIDE.*LEFT)([^A-Z0-9.]|$)', 'Lss'),
            (r'(^|[^A-Z0-9.])(RSS|SSR|RIGHT.*SIDE|SIDE.*RIGHT)([^A-Z0-9.]|$)', 'Rss'),
            (r'(^|[^A-Z0-9.])(LRS|SRL|LEFT.*REAR|REAR.*LEFT|BACK.*LEFT)([^A-Z0-9.]|$)', 'Lrs'),
            (r'(^|[^A-Z0-9.])(RRS|SRR|RIGHT.*REAR|REAR.*RIGHT|BACK.*RIGHT)([^A-Z0-9.]|$)', 'Rrs'),
            (r'(^|[^A-Z0-9.])(LS|LEFT.*SURROUND|SURROUND.*LEFT)([^A-Z0-9.]|$)', 'Ls'),
            (r'(^|[^A-Z0-9.])(RS|RIGHT.*SURROUND|SURROUND.*RIGHT)([^A-Z0-9.]|$)', 'Rs'),
            (r'(^|[^A-Z0-9.])(FC|FRONT.*CENTER|CENTER.*FRONT)([^A-Z0-9.]|$)', 'C'),
            (r'(^|[^A-Z0-9.])(FL|FRONT.*LEFT)([^A-Z0-9.]|$)', 'L'),
            (r'(^|[^A-Z0-9.])(FR|FRONT.*RIGHT)([^A-Z0-9.]|$)', 'R'),
            (r'(^|[^A-Z0-9.])(CENTER|CENTRE)([^A-Z0-9.]|$)', 'C'),
            (r'(^|[^A-Z0-9.])LEFT([^A-Z0-9.]|$)', 'L'),
            (r'(^|[^A-Z0-9.])RIGHT([^A-Z0-9.]|$)', 'R'),
            (r'(^|[^A-Z0-9.])L([^A-Z0-9.]|$)', 'L'),
            (r'(^|[^A-Z0-9.])R([^A-Z0-9.]|$)', 'R'),
        ]
    ...
    def _guess_channel_by_index(self, file_count: int, file_index: int) -> str:
        ...
        if not self.current_template or self.current_template not in CHANNEL_TEMPLATES:
            ...
            for i, (path, _) in enumerate(self.selected_files):
                if self.selected_files[i][1] == "?":
                    # 1. 尝试读取 iXML 元数据
                    ixml_label = self._read_wav_channel_label(path)
                    if ixml_label:
                        self.selected_files[i] = (path, ixml_label)
                        continue
                    # 2. 回退到文件名识别
                    name = Path(path).stem
                    ch_id = self._extract_channel_id(name)
                    if ch_id:
                        self.selected_files[i] = (path, ch_id)
                    else:
                        # 3. 根据文件数量和顺序推断标准配置
                        guessed = self._guess_channel_by_index(len(self.selected_files), i)
                        if guessed:
        ...
        for ch_idx, (ch_name, pattern) in enumerate(zip(channels, patterns)):
            ...
            for file_idx, (path, current_ch) in enumerate(self.selected_files):
                ...
                # 1. 使用 _extract_channel_id 映射（高优先级，5000分）
                    ...
                    extracted_id = self._extract_channel_id(filename)
